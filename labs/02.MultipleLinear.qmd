...
*Note for the practical: copy/editor/document the code in your own `.qmd` file. The code is supposed to be run as if the script was placed in the course folder, containing the dataset. That should be the working directory of RStudio.*
